...
class ShippersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipper" do
    assert_difference('Shipper.count') do
      post shippers_url, params: { shipper: { company_name: @shipper.company_name, contact: @shipper.contact, email: @shipper.email, notes: @shipper.notes, phone: @shipper.phone } }, as: :json
    end
  ...
  test "should update shipper" do
    patch shipper_url(@shipper), params: { shipper: { company_name: @shipper.company_name, contact: @shipper.contact, email: @shipper.email, notes: @shipper.notes, phone: @shipper.phone } }, as: :json
    assert_response 200
  end
